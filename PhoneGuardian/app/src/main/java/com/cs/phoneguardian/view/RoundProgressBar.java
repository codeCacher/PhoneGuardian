...
public class RoundProgressBar extends View {
	...
	/**
	 * 结束角度，由startAngle开始顺时针到endAngle,决定进度范围
	 */
...
//		canvas.drawCircle(centre, centre, radius, paint); //画出圆环
		for(int i = 0; i< mIntervalCount; i++){
			canvas.drawArc(mOval,i*360f/ mIntervalCount,180f/ mIntervalCount,false,paint);
		}
		...
		case STROKE:{
			...
			for(int i = 0; i<1f*progress* mIntervalCount /max; i++){
				canvas.drawArc(mOval,i*360f/ mIntervalCount,180f/ mIntervalCount,false,paint);
			}
			break;
		}
